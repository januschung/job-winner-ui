...
import { UPDATE_JOB_APPLICATION } from '../graphql/mutation';
...
export default function JobApplicationDialog({jobApplication, handleClose, open, setOpen}){

    console.log("company name: " + jobApplication.companyName)
    ...
    const [description, setDescription] = useState(jobApplication.description);
